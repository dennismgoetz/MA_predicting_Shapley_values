...
Topic: Generating and preparing TSP Instances for Shapley Value analysis
"""
...
number_of_instances_per_size = 10    # <- Diese Einstellungen generieren jetzt je 10 Instanzen mit 10 und 11 Kunden
...
for num_customers in num_customer_list:
    ...
    instance_numbers = range(start_value,start_value + number_of_instances_per_size)
    ...
    for inumber in instance_numbers:
        ...
        subset_total_cost = {} # Hier berechne ich ertst die charakteristische Funktion und darauf aufbauend dann den Shapley Value
        count = 0
